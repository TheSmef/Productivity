namespace Productivity.Shared.Utility.Constants
{
    public static class ContextConstants
    {
        ...
        public const string EmptyElement = "Элемент файла не может быть пустым";
        ...
        public const string AccountNotFound = "Данный аккаунт не существует";
        ...
        public const string CannotBeDeletedTitle = "Ошибка удаления";
        ...
        public const string NotFoundErrorTitle = "Запись не существует";
        public const string NotFoundError = "Невозможно изменить запись, так как она не существует";
