    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f0e290a9-9054-4ae7-af3b-08dad84feb5b"), "admin@admin.com", "admin", "$2a$11$TyQfIInP3YhERqgIj8xRpeTZo3DrArbqVQXkcR7ABBUaz2Fs.YZ/W" });

            migrationBuilder.CreateIndex(
                name: "UN_Email_Account",
                table: "Accounts",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UN_Login_Account",
                table: "Accounts",
                column: "Login",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UN_Productivity",
                table: "Productivities",
                columns: new[] { "CultureId", "RegionId", "Year" },
                unique: true);
